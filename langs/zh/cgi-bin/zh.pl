...
'mac desc' => '更改red0上的MAC地址。地址必须以十六进制（0-9，a-f）输入，有效条目为 <br />例如:00-01-02-0e-b8-d6 或 00:01:02:0e:b8:d6。',
'mac filter' => 'MAC过滤',
'mac new' => '新的MAC地址：',
...
'ovpn roadwarrior server' => 'OpenVPN Roadwarrior服务器',
...
'pakfire core update auto' => '自动安装核心和附加更新：',
'pakfire core update level' => '核心更新版本',
'pakfire finished' => 'Pakfire 已完结！正在返回……',
...
'pakfire possible dependency' => '这是需要安装的包的列表。',
'pakfire refresh list' => '刷新列表',
'pakfire register' => '在pakfire服务器上注册:',
'pakfire resolvedeps wait' => '正在检查依赖关系，请等待...',
...
'wg rw peers' => 'WireGuard Roadwarrior 对端',
