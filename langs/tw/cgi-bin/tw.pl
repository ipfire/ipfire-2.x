...
'mac desc' => '在這裡你可以更改 red0 上的 MAC 地址。地址必須以十六進位（0-9，a-f）輸入，有效條目為 <br />例如 00-01-02-0e-b8-d6 或 00:01:02:0e:b8:d6。',
'mac filter' => 'MAC 過濾',
'mac new' => '新的MAC地址：',
