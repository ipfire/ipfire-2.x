...
'fwhost addgeoipgrp' => 'Yeni Location grubu ekle',
...
'fwhost cust geoip' => 'Location Grupları',
'fwhost cust geoipgroup' => 'Location Grupları',
'fwhost cust geoiplocation' => 'Location Konumları',
...
'fwhost newgeoipgrp' => 'Location Grupları',
...
'genre' => 'Tür',
'geoip' => 'Location',
'geoipblock' => 'Location Engelleme',
'geoipblock block countries' => 'Engellenen ülkeler',
'geoipblock configuration' => 'Location Yapılandırması',
...
'geoipblock enable feature' => 'Location tabanlı engellemeyi aktifleştir:',
