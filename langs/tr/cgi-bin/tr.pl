...
'advproxy IDENT use negative access list' => 'Negatif erişim kontrolü kullanın',
'advproxy IDENT use positive access list' => 'Pozitif erişim kontrolü kullanın',
...
'advproxy NCSA update user' => 'Kullanıcı güncelleme',
...
'advproxy NTLM use negative access list' => 'Negatif erişim kontrolü kullanın',
'advproxy NTLM use positive access list' => 'Pozitif erişim kontrolü kullanın',
...
'advproxy RADIUS use negative access list' => 'Negatif erişim kontrolü kullanın',
'advproxy RADIUS use positive access list' => 'Pozitif erişim kontrolü kullanın',
...
'advproxy allowed subnets' => 'Alt ağlara izin ver (her satırda bir tane)',
...
'advproxy chgwebpwd change web password' => 'W e b &nbsp; e r i ş i m &nbsp; p a r a l o s a n ı &nbsp; d e ğ i ş t i r ',
...
'advproxy content based throttling' => 'İçerik tabanlı kısıtlamayı aktifleştir',
...
'advproxy cre supervisors' => 'Yönetici IP adresleri (her satırda bir tane)',
'advproxy destination ports' => 'Hedef bağlantı noktaları',
'advproxy download throttling' => 'İndirme kısıtlaması',
...
'advproxy no cre groups' => 'Uygun bir erişim grup yok',
...
'advproxy ssl ports' => 'SSL bağlantı noktasına izin ver (her satırda bir tane)',
'advproxy standard' => 'Standart',
'advproxy standard ports' => 'Standart bağlantı noktasına izin ver (her satırda bir tane)',
'advproxy sunday' => 'Paz',
'advproxy supervisor password' => 'Yönetici parolası',
...
'advproxy throttling per host on' => 'Ana bilgisayar başına sınır',
...
'cached' => 'önbellek',
'cached memory' => 'Önbellek Balleği  ',
...
'calamaris enable content report' => 'İçerik raporu aktif',
...
'calamaris run as background task' => 'Arka plan görevi olarak çalıştırın',
...
'ccd dynrange' => 'Dinamik OpenVPN IP adresi havuzu',
...
'ccd iroute' => 'IPFire istemcilerinin sitesinde bu ağlara erişimi',
'ccd iroute2' => 'İstemcilerin IPFire sitesinde bu ağlara erişimi',
...
'clenabled' => 'Yerel ağa zamanını ver',
...
'connscheduler' => 'Bağlantı Zamanlayıcısı',
...
'cpu nice usage' => 'İyi CPU Kullanımı',
...
'current hosts' => 'Mevcut ana bilgisayar:',
...
'def lease time' => 'Varsayılan Kiralama Zamanı',
'default lease time' => 'Varsayılan kiralama zamanı (dakika):',
...
'dl client arch' => 'İstemci Paketlerini İndir (zip)',
'dmz' => 'DMZ',
'dmz pinhole configuration' => 'DMZ pinhole yapılandırma',
'dmz pinhole rule added' => 'DMZ pinhole kuralı eklendi; DMZ pinhole yeniden başlatılıyor',
'dmz pinhole rule removed' => 'DMZ pinhole kuralı silindi; DMZ pinhole yeniden başlatılıyor',
'dmzpinholes for same net not necessary' => 'DMZ Pinhole aynı ağ için gerekli değildir. Farklı kaynak veya hedef ağ seçin.',
...
'edit hosts' => 'Ana Bilgisayarı Düzenle',
...
'extrahd detected drives' => 'algılanan sürücüler',
...
'fireinfo is submitted' => 'Profiliniz güvenlik duvarı bilgi hizmetini gönderildi.',
...
'firewall logs port' => 'Gd-Günlük Grafikleri (Bağlantı noktası)',
'firewallhits' => 'güvenlik duvarı kaydı',
'firmware' => 'Yazılım',
'firmware upload' => 'Yazılım/Sürücüler Yükle',
...
'instant update' => 'Hızlı Güncelleme',
'interface' => 'Ara birim',
...
'ipinfo' => 'IP bilgi',
'iptable rules' => 'IPTable kuralları',
'iptmangles' => 'IPTable Sıkıştırmaları',
'iptnats' => 'IPTable Ağ Adres Çevrimi',
'ipts' => 'IPTables',
'isdn' => 'ISDN',
...
'mac address menu' => 'MAC-Adresi Atama',
...
'magic packet send to:' => 'Sihir paketi gönder:',
...
'net config type help' => 'YEŞİL yerel ağ, KIRMIZI internet, MAVİ kablosuz ağ, TURUNCU DMZ ağıdır.',
...
'network time from' => 'Bir ağ sunucusundan zamanı al',
...
'outgoing firewall p2p description 3' => 'bu p2p kuralı engellendi.',
...
'ovpn mtu-disc' => 'MTU Keşif Yolu',
'ovpn mtu-disc and mtu not 1500' => 'MTU Keşif Yolunun 1500 MTU olmasını gerektirir.',
'ovpn mtu-disc maybe' => 'İsteğe Bağlı',
'ovpn mtu-disc no' => 'Asla',
'ovpn mtu-disc off' => 'Devre dışı',
'ovpn mtu-disc with mssfix or fragment' => 'MTU Keşif Yolu mssfix veya parçası ile kullanılamaz.',
...
'ovpn routes push' => 'Rotalar (her satırda bir tane) örneğin 192.168.10.0/255.255.255.0 192.168.20.0/24',
'ovpn routes push options' => 'Rota basma seçenekleri',
...
'pakfire last core list update' => 'Yapılan son çekirdek listesi güncellemesi',
'pakfire last package update' => 'Yapılan son paket listesi güncellemesi',
'pakfire last serverlist update' => 'Yapılan son sunucu listesi güncellemesi',
'pakfire last update' => 'Yapılan son güncelleme',
...
'proxy filedescriptors' => 'Dosya tanimlayıcı sayısı miktarı',
...
'select source net' => 'Kaynak ağı seçin. Eğer yapılandırılmamış TURUNCU veya MAVİ ağ varsa DMZ\'ye gerek yoktur',
...
'squid fix cache' => 'Onarım belleği',
...
'state or province' => 'Devlet veya Şehir',
'static ip' => 'Statik IP',
...
'summaries kept' => 'Özetler için tutulan',
'sunday' => 'Pazar',
'swap' => 'Takas Alanı',
...
'updxlrtr passive mode' => 'Pasif yöntemini aktifleştirin',
...
'upload' => 'Yükle',
'upload a certificate' => 'Yükleme sertifikası:',
'upload a certificate request' => 'Bir sertifika isteği yükle:',
...
'urlfilter add new time constraint rule' => 'Yeni süre sınırlaması kuralı ekle',
...
'urlfilter allowed domains' => 'Etki alanlarına izin ver (her satırda bir tane)',
'urlfilter allowed urls' => 'URL adreslerine izin ver (her satırda bir tane)',
...
'urlfilter automatic update schedule' => 'Otomatik olarak güncelleştirme zamanlaması',
...
'urlfilter backup' => 'Yedek dosyası oluşturun',
...
'urlfilter block audio-video' => 'Audio/Video dosyalarını engelle',
...
'urlfilter block settings' => 'Engelleme sayfa ayarları',
...
'urlfilter custom url' => 'Özel kaynak URL',
...
'urlfilter enable automatic blacklist update' => 'Otomatik güncelleme aktifleştir',
...
'urlfilter enable full backup' => 'Eklenen kara liste tamamlandı',
...
'urlfilter load blacklist' => 'Kara liste yükle',
'urlfilter local file redirection' => 'Yerel dosyayı yeniden yönlendir',
...
'urlfilter upload blacklist' => 'Kara liste yükle',
