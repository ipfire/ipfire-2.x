...
'Captive WiFi coupon' => 'Cupón WiFi',
...
'Captive heading voucher' => 'Cupón o Código de Acceso',
...
'access point name is invalid' => 'El nombre del Punto de Acceso no es válido',
...
'dhcp fixed ip address in dynamic range' => 'Dirección IP fija en rango dinámico',
...
'downfall gather data sampling' => 'Muestreo de datos de caída/recopilación',
...
'email invalid mailip' => 'Dirección del servidor de correo no válida',
...
'endpoint' => 'Endpoint',
'endpoint address' => 'Dirección del Endpoint',
...
'extrahd because it it outside the allowed mount path' => ', porque está fuera de la ruta de montaje permitida',
...
'extrahd no mount point given' => 'No se ha indicado ningún punto de montaje',
...
'fwdfw syn flood protection' => 'Habilitar protección contra inundaciones SYN (solo TCP)',
...
'gpl i accept these terms and conditions' => 'Acepto estos términos y condiciones',
'gpl license agreement' => 'Acuerdo de licencia',
'gpl please read carefully the general public license and accept it below' => 'Por favor, lea atentamente la Licencia Pública General y acéptela a continuación.',
'gpl unofficial translation of the general public license v3' => 'Traducción no oficial de la Licencia Pública General v3',
'graph' => 'Gráfico',
'graph per' => 'por',
'green' => 'Green',
...
'imei' => 'IMEI',
'import' => 'Importar',
'import connection' => 'Importar una conexión',
...
'invalid endpoint' => 'Endpoint no válido',
'invalid endpoint address' => 'Dirección de Endpoint no válido',
...
'invalid ip or hostname' => 'Dirección IP o nombre de host no válidos',
'invalid keep time' => 'El tiempo de almacenamiento debe ser un número válido',
'invalid keepalive interval' => 'Intervalo de Keepalive no válido',
...
'ipblocklist hits' => 'Número total de accesos a la lista de bloqueo para',
...
'malformed public key' => 'Clave pública mal formada',
...
'password has quotation mark' => 'La contraseña contiene comillas dobles ilegales.',
...
'service boot setting unavailable' => 'No se encontró ningún enlace simbólico de nivel de ejecución válido para el script de inicio de este servicio.',
...
'system time' => 'Hora del sistema (en la última carga de la página)',
...
'weeks' => 'Semanas',
'wg' => 'WireGuard',
'wg client configuration file' => 'Archivo de configuración del cliente WireGuard',
...
'wg dns' => 'DNS',
'wg download configuration' => 'Descargar configuración',
'wg download configuration file' => 'Descargar el archivo de configuración',
...
'wg host to net client settings' => 'Configuración Cliente Host-To-Net',
'wg import peer' => 'Importar Par',
'wg invalid client dns' => 'Dirección DNS de cliente no válida',
'wg invalid client pool' => 'Grupo de clientes no válido',
'wg invalid endpoint address' => 'Dirección de endpoint no válida',
'wg invalid endpoint port' => 'Puerto endpoint no válido',
'wg invalid keepalive interval' => 'Intervalo de Keepalive no válido (debe estar entre 0 y 65535)',
'wg invalid local subnet' => 'Subred local no válida',
'wg invalid name' => 'Nombre no válido (solo se permiten letras, números, espacios y guiones)',
'wg invalid psk' => 'Clave precompartida no válida',
'wg invalid public key' => 'Clave pública no válida',
'wg invalid remote subnet' => 'Subred remota no válida',
'wg keepalive interval' => 'Intervalo Keepalive',
'wg leave empty to automatically select' => 'Dejar vacío para seleccionar automáticamente',
'wg missing allowed ips' => 'IP permitidas faltantes',
'wg missing endpoint address' => 'Dirección de Endpoint faltante',
...
'wg missing public key' => 'Clave pública faltante',
'wg name is already used' => 'El nombre ya está en uso',
'wg no local subnets' => 'No se proporcionaron subredes locales',
'wg no more free addresses in pool' => 'No hay más direcciones libres en el grupo',
'wg no remote subnets' => 'No se proporcionaron subredes remotas',
'wg peer configuration' => 'Configuración del Peer',
...
'wg scan the qr code' => 'Escanee el código QR para importar la configuración de WireGuard a un cliente móvil.',
'wg show configuration qrcode' => 'Mostrar código QR de configuración',
'wg warning configuration only shown once' => 'Atención: este archivo de configuración de WireGuard solo se mostrará esta vez, ya que contiene material de clave privada que no se almacena en IPFire.',
...
'wlan client configuration' => 'Configuración del Cliente Inalámbrico',
...
'wlanap' => 'Punto de Acceso Inalámbrico',
...
'wlanap wireless mode' => 'Modo Inalámbrico',
