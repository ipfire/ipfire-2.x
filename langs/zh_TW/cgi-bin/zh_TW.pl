...
'alias ip' => '別名IP',
'aliases' => '外部別名',
'aliases default interface' => '-  默認接口 -',
...
'ccd hint' => '在此頁面上，您可以定義靜態網絡，遠程接入客戶端可以從中獲取固定的IP位址分配。',
'ccd invalid' => '無效。',
...
'core notice 2' => '到',
'core notice 3' => '可用。',
'core update' => '漢化：<a href="https://pfchina.org/" target="_blank">鐵血男兒</a>，核心版本：',
...
'external aliases configuration' => '別名配置',
'extrahd' => '外部磁碟',
...
'fwhost invalid country code' => '無效的國家代碼',
...
'generate iso' => '生成ISO',
'generate pdf report for' => '生成PDF報告：',
'generate ptr' => '生成PTR',
...
'host deny' => '拒絕的主機列表',
'host ip' => '主機IP位址',
'host to net vpn' => '主機到網絡虛擬專用網（遠程接入）',
...
'ids all including informational' => '全部（包括信息性警報）',
'ids apply' => '應用',
...
'ids email alert severity' => '嚴重級別',
'ids email alerts' => '郵件警報',
'ids email recipients' => '收件人',
'ids email sender' => '發件人地址',
'ids enable' => '啟用入侵檢測系統',
...
'ids hide' => '隱藏',
'ids high and medium severity' => '高和中等嚴重級別',
'ids high severity only' => '僅高嚴重級別',
'ids high, medium and low severity' => '高、中和低嚴重級別',
'ids ignored hosts' => '白名單',
'ids invalid mail address' => '包含無效的郵件地址。',
...
'ids no email recipients' => '未指定郵件收件人',
'ids no email sender' => '未指定發件人郵件地址',
...
'ids reports daily' => '發送每日報告',
'ids reports monthly' => '發送每月報告',
'ids reports weekly' => '發送每周報告',
...
'ids rulesets' => '規則集',
'ids send email on alert' => '發生警報時發送郵件',
'ids show' => '顯示',
...
'indirect target selection' => '間接目標選擇',
'info' => '信息',
'init string' => '提示:',
'inodes' => '索引節點',
...
'mac address saved txt' => 'MAC地址已成功保存，但更改僅在重啟或重新連接後生效。',
'mac address title' => '分配MAC地址',
'mac desc' => '更改red0上的MAC地址。以十六進位（0-9，a-f）表示。 <br />例如：00-01-02-0e-b8-d6 或 00:01:02:0e:b8:d6。',
'mac filter' => 'MAC過濾',
'mac new' => '新MAC地址：',
...
'ovpn crypto settings' => '加密設置',
'ovpn device' => 'OpenVPN設備:',
'ovpn dhcp settings' => 'DHCP設置',										
'ovpn dl' => 'OVPN-Config 下載',
'ovpn dynamic client subnet' => '動態客戶端子網',
'ovpn engines' => '加密引擎',
'ovpn errmsg green already pushed' => '始終設置綠色網絡的路由',
'ovpn errmsg invalid ip or mask' => '無效的網絡地址或子網掩碼',
'ovpn errmsg invalid route' => '無效路由',
'ovpn error md5' => '您的主機證書使用 MD5 簽名，但該簽名已不再被接受。<br>請更新到最新的 IPFire 版本並生成新的根證書和主機證書。</br><br>所有 OpenVPN 客戶端都需要續訂！</br>',
'ovpn fallback cipher' => '後備密碼',
'ovpn fallback cipher help' => '此密碼正被不支持密碼協商的客戶端使用。',
'ovpn fqdn' => 'FQDN',																 					  
'ovpn generating the root and host certificates' => '生成根證書和主機證書可能需要很長時間。',
'ovpn ha' => '哈希算法',
'ovpn log' => 'OVPN-Log',
'ovpn mgmt in root range' => '埠號為1024或更高。',
'ovpn misc settings' => '其他設置',												 
...
'ovpn protocol settings' => '協議設置',
'ovpn push default route' => '推送默認路由',
'ovpn reneg sec' => '會話密鑰有效期:',
'ovpn roadwarrior server' => 'OpenVPN 遠程連接伺服器',
'ovpn roadwarrior settings' => '遠程連接設置',
'ovpn routes push' => '自定義路由',
'ovpn routing settings' => '路由設置',									  
'ovpn rw connection log' => 'OpenVPN連接日誌',
...
'ovpn transport protocol' => '傳輸協議',
'ovpn unsupported cipher selected' => '選擇了未知密碼',
'ovpn warning rfc3280' => '您的主機證書不符合 RFC3280 標準。<br>請更新至最新的 IPFire 版本，並儘快生成新的根證書和主機證書。</br><br>所有 OpenVPN 客戶端都需要更新！</br>',
'ovpn_fastio' => 'Fast-IO',
...
'pakfire confirm upgrades' => '是否要安裝所有更新？',
'pakfire core update level' => '當前核心版本',
'pakfire deps' => '軟體包依賴項：',
'pakfire errors' => '發生錯誤：',
'pakfire finished' => 'Pakfire 已完成！正在返回……',
'pakfire finished error' => 'Pakfire完成！ 但發生錯誤，請在繼續之前檢查日誌。',
'pakfire install' => '安裝',
'pakfire install description' => '請從下面的列表中選擇一項或多項，然後單擊進行安裝。',
'pakfire install package' => '您要安裝以下軟體包: ',
'pakfire installed' => '已經安裝',
'pakfire installed addons' => '已安裝插件:',
'pakfire inuse' => '正在使用的插件：',										   
'pakfire invalid tree' => '選擇了無效的存儲庫',
'pakfire keep' => '由於依賴關係而需要保留的插件：',									  
...
'pakfire no deps' => '未發現依賴項。',
'pakfire no remove' => '由於依賴性，無法刪除任何插件。',
'pakfire package' => '插件:',
'pakfire refresh list' => '刷新列表',
'pakfire remove package' => '要刪除的插件：',
...
'pakfire uninstall description' => '請從下面的列表中選擇一項或多項，然後單擊進行卸載。',
'pakfire updating' => '正在更新 pakfire 資料庫，請稍候...',
'pakfire upgrade' => '更新',
...
'password has quotation mark' => '密碼包含非法雙引號。',
...
'tor use guard nodes' => '僅使用這些保護節點（每行一個指紋）',
'total' => 'Total',
...
'transfers' => '傳輸',
'transient sheduler attacks' => '暫態調度器攻擊',
'transparent on' => '透明',
...
'yes' => '是',
'you can only define one roadwarrior connection when using pre-shared key authentication' => '使用預共享密鑰身份驗證時，您只能定義一個遠程接入連接。<br />您已經建立了帶有預共享密鑰身份驗證的遠程接入連接，或者您現在嘗試添加一個。',
