...
'advproxy admin mail' => 'Cache email administrateur ',
...
'icmp selected but no type' => 'ICMP est le protocole séléctionné, mais il n\'y a aucun type ICMP spécifié.',
'icmp type' => 'Type ICMP',
'id' => 'ID',
'idle' => 'Inactif',
...
'ovpn errmsg green already pushed' => 'La route pour le réseau green est toujours activée',
...
'pakfire install description' => 'Veuillez choisir un ou plusieurs objets dans la liste ci-dessous<br>et cliquez sur le plus pour installer.',
...
'pakfire uninstall description' => 'Veuillez choisir un ou plusieurs objets dans la liste ci-dessous<br>et cliquez sur le moins pour désinstaller.',
...
'urlfilter block settings' => 'Réglages URL Filter',
...
'urlfilter install information' => 'La nouvelle liste noire va être automatiquement compilée pour préparer les bases de données. Ceci peut durer plusieurs minutes et dépend de la taille de la blacklist.',
...
'urlfilter upload information' => 'La nouvelle liste noire va être automatiquement compilée pour préparer les bases de données. Le temps dépend de la taille de la blacklist, ceci peut durer plusieurs minutes. Attendre la fin de cette tâche pour relancer URL filter.',
...
'week' => 'Semaine',
'week-graph' => 'Semaine',
'weekly firewallhits' => 'Hits hebdomadaires du pare-feu',
'weeks' => 'semaines',
'wildcards' => 'Jokers',
