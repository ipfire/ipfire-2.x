...
'alias ip' => '别名IP',
'aliases' => '外部别名',
'aliases default interface' => '-  默认接口 -',
...
'ca certificate' => 'CA证书',
'ca name' => 'CA名称',
'ca name must only contain characters or spaces' => 'CA名称只能包含字符或空格。',
...
'ccd hint' => '在此页面上，您可以定义静态网络，远程接入客户端可以从中获取固定的IP地址分配。',
'ccd invalid' => '无效。',
...
'duration' => '期间',
'dyn dns source choice' => '动态DNS提供商将从以下位置获取该IPFire的IP地址:',
'dynamic dns' => '动态DNS',
...
'external aliases configuration' => '别名配置',
'extrahd' => '外部磁盘',
...
'fwdfw syn flood protection' => '启用SYN洪水保护（仅限 TCP）',
'fwdfw target' => '目标',
...
'fwhost invalid country code' => '无效的国家代码',
...
'generate iso' => '生成ISO',
'generate pdf report for' => '生成PDF报告：',
'generate ptr' => '生成PTR',
...
'host deny' => '拒绝的主机列表',
'host ip' => '主机IP地址',
'host to net vpn' => '主机到网络虚拟专用网（远程接入）',
...
'ids all including informational' => '全部（包括信息性警报）',
'ids apply' => '应用',
...
'ids email alert severity' => '严重级别',
'ids email alerts' => '邮件警报',
'ids email recipients' => '收件人',
'ids email sender' => '发件人地址',
'ids enable' => '启用入侵检测系统',
...
'ids hide' => '隐藏',
'ids high and medium severity' => '高和中等严重级别',
'ids high severity only' => '仅高严重级别',
'ids high, medium and low severity' => '高、中和低严重级别',
'ids ignored hosts' => '白名单',
'ids invalid mail address' => '包含无效的邮件地址。',
...
'ids no email recipients' => '未指定邮件收件人',
'ids no email sender' => '未指定发件人邮件地址',
...
'ids reports daily' => '发送每日报告',
'ids reports monthly' => '发送每月报告',
'ids reports weekly' => '发送每周报告',
...
'ids rulesets' => '规则集',
'ids send email on alert' => '发生警报时发送邮件',
'ids show' => '显示',
...
'invalid endpoint address' => '端点地址无效',
...
'invalid input for subscription code' => '订阅代码输入无效',
...
'invalid keepalive interval' => '无效的保活间隔',
'invalid key' => '无效的密钥',
...
'mac address saved txt' => 'MAC地址已成功保存，但更改仅在重启或重新连接后生效。',
'mac address title' => '分配MAC地址',
'mac desc' => '更改red0上的MAC地址。以十六进制（0-9，a-f）表示。 <br />例如：00-01-02-0e-b8-d6 或 00:01:02:0e:b8:d6。',
'mac filter' => 'MAC过滤',
'mac new' => '新MAC地址：',
...
'mailprogramm' => '邮件程序',
'main page' => '主页',
'malformed preshared key' => '格式错误的预共享密钥',
'malformed private key' => '格式错误的私钥',
'malformed public key' => '格式错误的公钥',
'manage ovpn' => '5. 隧道管理:',
...
'ovpn crypto settings' => '加密设置',
'ovpn device' => 'OpenVPN设备:',
'ovpn dhcp settings' => 'DHCP设置',										
'ovpn dl' => 'OVPN-Config 下载',
'ovpn dynamic client subnet' => '动态客户端子网',
'ovpn engines' => '加密引擎',
'ovpn errmsg green already pushed' => '始终设置绿色网络的路由',
'ovpn errmsg invalid ip or mask' => '无效的网络地址或子网掩码',
'ovpn errmsg invalid route' => '无效路由',
'ovpn error md5' => '您的主机证书使用 MD5 签名，但该签名已不再被接受。<br>请更新到最新的 IPFire 版本并生成新的根证书和主机证书。</br><br>所有 OpenVPN 客户端都需要续订！</br>',
'ovpn fallback cipher' => '后备密码',
'ovpn fallback cipher help' => '此密码正被不支持密码协商的客户端使用。',
'ovpn fqdn' => 'FQDN',																 					  
'ovpn generating the root and host certificates' => '生成根证书和主机证书可能需要很长时间。',
'ovpn ha' => '哈希算法',
'ovpn log' => 'OVPN-Log',
'ovpn mgmt in root range' => '端口号为1024或更高。',
'ovpn misc settings' => '其他设置',												 
...
'ovpn protocol settings' => '协议设置',
'ovpn push default route' => '推送默认路由',
'ovpn reneg sec' => '会话密钥有效期:',
'ovpn roadwarrior server' => 'OpenVPN 远程连接服务器',
'ovpn roadwarrior settings' => '远程连接设置',
'ovpn routes push' => '自定义路由',
'ovpn routing settings' => '路由设置',									  
'ovpn rw connection log' => 'OpenVPN连接日志',
...
'ovpn transport protocol' => '传输协议',
'ovpn unsupported cipher selected' => '选择了未知密码',
'ovpn warning rfc3280' => '您的主机证书不符合 RFC3280 标准。<br>请更新至最新的 IPFire 版本，并尽快生成新的根证书和主机证书。</br><br>所有 OpenVPN 客户端都需要更新！</br>',
'ovpn_fastio' => 'Fast-IO',
...
'pakfire check deps' => '正在检查依赖项...',
'pakfire configuration' => 'Pakfire配置',
'pakfire confirm upgrades' => '是否要安装所有更新？',
'pakfire core update level' => '当前核心版本',
'pakfire deps' => '软件包依赖项：',
'pakfire errors' => '发生错误：',
'pakfire finished' => 'Pakfire 已完成！正在返回……',
'pakfire finished error' => 'Pakfire完成！ 但发生错误，请在继续之前检查日志。',
'pakfire install' => '安装',
'pakfire install description' => '请从下面的列表中选择一项或多项，然后单击进行安装。',
'pakfire install package' => '您要安装以下软件包: ',
'pakfire installed' => '已经安装',
'pakfire installed addons' => '已安装插件:',
'pakfire inuse' => '正在使用的插件：',										   
'pakfire invalid tree' => '选择了无效的存储库',
'pakfire keep' => '由于依赖关系而需要保留的插件：',									  
...
'pakfire no deps' => '未发现依赖项。',
'pakfire no remove' => '由于依赖性，无法删除任何插件。',
'pakfire package' => '插件:',
'pakfire refresh list' => '刷新列表',
'pakfire remove package' => '要删除的插件：',
...
'pakfire uninstall description' => '请从下面的列表中选择一项或多项，然后单击进行卸载。',
'pakfire updating' => '正在更新 pakfire 数据库，请稍候...',
'pakfire upgrade' => '更新',
...
'password has quotation mark' => '密码包含非法双引号。',
...
'set' => 'set',
'set time now' => '立即设置时间',
'set time now help' => '要在任何时候（甚至在使用重复计划时）将同步事件排队，请单击<i>立即设置时间</ i>按钮。 请注意，在同步事件发生之前，您可能需要等待五分钟或更长时间。',
'settings' => '设置',
...
'tor accounting limit' => '计费限制（MB）',
'tor accounting period' => '计费区间',
...
'tor enabled' => '启用Tor',
'tor errmsg invalid accounting limit' => '无效的计费限额',
...
'tor use guard nodes' => '仅使用这些保护节点（每行一个指纹）',
'total' => 'Total',
...
'transfers' => '传输',
'transient sheduler attacks' => '暂态调度器攻击',
'transparent on' => '透明',
...
'weeks' => '周',
'wg' => 'WireGuard',
'wg client configuration file' => 'WireGuard 客户端配置文件',
'wg client pool' => '客户端地址池',
'wg create host-to-net peer' => '创建Host-To-Net对端',
'wg create net-to-net peer' => '创建Net-To-Net对端',
'wg create peer' => '创建新的对端',
'wg dns' => 'DNS',
'wg download configuration' => '下载配置',
'wg download configuration file' => '下载配置文件',
'wg edit host-to-net peer' => '编辑Host-To-Net对端',
'wg edit net-to-net peer' => '编辑Net-To-Net对端',
'wg edit peer' => '编辑对端',
'wg host to net client settings' => 'Host-To-Net客户端设置',
'wg import peer' => '导入对端',
...
'wg invalid keepalive interval' => '无效的Keepaliv间隔（必须在 0 到 65535 之间）',
...
'wg keepalive interval' => 'Keepalive 间隔',
'wg leave empty to automatically select' => '留空将自动选择',
...
'wg name is already used' => '名称已被使用',
'wg no local subnets' => '未提供本地子网',
'wg no more free addresses in pool' => '地址池中无可用地址',
'wg no remote subnets' => '未提供远程子网',
'wg peer configuration' => '对端配置',
'wg peer does not exist' => '对端不存在',
'wg pre-shared key (optional)' => '预共享密钥（可选）',
'wg rw peers' => 'WireGuard 远程连接端点',
'wg scan the qr code' => '扫描二维码以将 WireGuard 配置导入移动客户端。',
'wg show configuration qrcode' => '显示配置二维码',
'wg warning configuration only shown once' => '注意：此WireGuard配置文件只会显示一次，因为它包含不会被IPFire存储的私钥信息。',
...
'wlanap verbose' => '详细',
'wlanap warnings' => '警告',
'wlanap wireless mode' => '无线模式',
'wlanap wlan card' => 'WLan Card',
'wlanap wlan clients' => 'WiFi客户端',
...
'yes' => '是',
'you can only define one roadwarrior connection when using pre-shared key authentication' => '使用预共享密钥身份验证时，您只能定义一个远程接入连接。<br />您已经建立了带有预共享密钥身份验证的远程接入连接，或者您现在尝试添加一个。',
