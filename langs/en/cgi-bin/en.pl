...
'dns isp assigned nameserver' => 'ISP assigned nameserver',
'dns list' => 'List of free public DNS servers',
'dns menu' => 'Assign DNS-Server',
'dns mode for qname minimisation' => 'Mode for QNAME minimisation',
...
'dns use isp assigned nameservers' => 'Use ISP assigned nameservers',
'dns use protocol for dns queries' => 'Used protocol for DNS queries',
