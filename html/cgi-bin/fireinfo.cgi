...
<font color="$Header::colourred">
	<p>
		...
		$Lang::tr{'fireinfo why descr2'}<a href="https://fireinfo.ipfire.org" target="_blank" rel="noopener">$Lang::tr{'fireinfo why read more'}</a>
	</p>
</font>
END
...
<table width='100%'>
	<tr>
		...
		<td>
			<a href="https://fireinfo.ipfire.org/profile/$profile_id" target="_blank" rel="noopener">$profile_id</a>
		</td>
	</tr>
	<tr>
		<!-- spacer -->
